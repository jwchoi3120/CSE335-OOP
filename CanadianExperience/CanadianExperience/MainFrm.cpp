...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(ID_TREE_FIRSTTREE, &CMainFrame::OnTreeFirsttree)
	ON_COMMAND(ID_TREE_SECONDTREE, &CMainFrame::OnTreeSecondtree)
...
void CMainFrame::OnTreeFirsttree()
{
	// TODO: Add your command handler code here
	auto tree = mPFactory.GetFirstTree();
...
void CMainFrame::OnTreeSecondtree()
{
	// TODO: Add your command handler code here
	auto tree = mPFactory.GetSecondTree();
	tree->SetKeyFrame(mPicture->GetTimeline()->GetCurrentFrame());
	mPicture->UpdateObservers();
	Invalidate();
}
...
{
	// TODO: Add your command handler code here
	//I tried... doesn't work... so sad.... maybe effort points??
}
