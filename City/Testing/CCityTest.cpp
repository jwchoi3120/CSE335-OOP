...
namespace Testing
{
	...
	public:
		...
		TEST_METHOD(TestCCityVisitor)
		{
			...
			city1.Accept(&visitor1);
			Assert::AreEqual(0, visitor1.mNumRoads, L"Visitor number of roads");
			Assert::AreEqual(0, visitor1.mNumBuildings, L"Visitor number of buildings");
			Assert::AreEqual(0, visitor1.mNumLandscapes, L"Visitor number of landscapes");
			Assert::AreEqual(0, visitor1.mNumCoalmines, L"Visitor number of coalmines");
		}
